...
1. **Toolchain obligatoire : go1.27rc3** (puis go1.27 stable dès sortie), avec
   `GOEXPERIMENT=simd` actif. Installée sous `/home/cl-ment/sdk/go1.27rc3/`,
   invocable `~/go/bin/go1.27rc3` ou via `GOTOOLCHAIN=go1.27rc3`.
