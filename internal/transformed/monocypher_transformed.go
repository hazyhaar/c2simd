...
func gap(x size_t, pow_2 size_t) (r size_t) {
	return (^x + uint64(1)) & (pow_2 - uint64(1))
}

func load24_le(s uintptr) (r u32) {
	return uint32(**(**u8)(__ccgo_up(s)))<<int32(0) | uint32(**(**u8)(__ccgo_up(s + 1)))<<int32(8) | uint32(**(**u8)(__ccgo_up(s + 2)))<<int32(16)
}

func load32_le(s uintptr) (r u32) { return *(*uint32)(unsafe.Pointer(s)) }

func load64_le(tls *libc.TLS, s uintptr) (r u64) {
	return uint64(load32_le(s)) | uint64(load32_le(s+uintptr(4)))<<int32(32)
}

func store32_le(out uintptr, in u32) { *(*uint32)(unsafe.Pointer(out)) = in }

func store64_le(tls *libc.TLS, out uintptr, in u64) {
	store32_le(out, uint32(in))
	store32_le(out+uintptr(4), uint32(in>>int32(32)))
}

func load32_le_buf(tls *libc.TLS, dst uintptr, src uintptr, size size_t) {
	var i size_t
	_ = i
	i = uint64(libc.Int32FromInt32(0))
	for {
		if !(i < size) {
			break
		}
		**(**u32)(__ccgo_up(dst + uintptr(i)*4)) = load32_le(src + uintptr(i*uint64(4)))
		goto _1
	_1:
		;
		i = i + 1
...
func store32_le_buf(tls *libc.TLS, dst uintptr, src uintptr, size size_t) {
	...
	for {
		...
		store32_le(dst+uintptr(i*uint64(4)), **(**u32)(__ccgo_up(src + uintptr(i)*4)))
		goto _1
	_1:
		;
		i = i + 1
...
func rotr64(x u64, n u64) (r u64) {
	return x>>n ^ x<<(uint64(64)-n)
}

func neq0(diff u64) (r int32) {
	var eq0, half u64
	_, _ = eq0, half
	// constant time comparison to zero
	// return diff != 0 ? -1 : 0
	half = diff>>int32(32) | uint64(uint32(diff))       // half < 2^32
...
func crypto_verify16(tls *libc.TLS, a uintptr, b uintptr) (r int32) {
	return neq0(x16(tls, a, b))
}

func crypto_verify32(tls *libc.TLS, a uintptr, b uintptr) (r int32) {
	return neq0(x32(tls, a, b))
}

func crypto_verify64(tls *libc.TLS, a uintptr, b uintptr) (r int32) {
	return neq0(x64(tls, a, b))
}

func crypto_wipe(secret uintptr, size size_t) {
	var _i_ size_t
	var v_secret uintptr
	_, _ = _i_, v_secret
	v_secret = secret
	_i_ = uint64(libc.Int32FromInt32(0))
	for {
		if !(_i_ < size) {
			break
		}
...
func chacha20_rounds(tls *libc.TLS, out uintptr, in uintptr) {
	...
	i = uint64(libc.Int32FromInt32(0))
	for {
		if !(i < uint64(libc.Int32FromInt32(10))) {
			break
		} // 20 rounds, 2 rounds per loop.
		t0 = t0 + t4
		t12 = bits.RotateLeft32(t12^t0, int(16))
		t8 = t8 + t12
		t4 = bits.RotateLeft32(t4^t8, int(12))
		t0 = t0 + t4
		t12 = bits.RotateLeft32(t12^t0, int(8))
		t8 = t8 + t12
		t4 = bits.RotateLeft32(t4^t8, int(7)) // column 0
		t1 = t1 + t5
		t13 = bits.RotateLeft32(t13^t1, int(16))
		t9 = t9 + t13
		t5 = bits.RotateLeft32(t5^t9, int(12))
		t1 = t1 + t5
		t13 = bits.RotateLeft32(t13^t1, int(8))
		t9 = t9 + t13
		t5 = bits.RotateLeft32(t5^t9, int(7)) // column 1
		t2 = t2 + t6
		t14 = bits.RotateLeft32(t14^t2, int(16))
		t10 = t10 + t14
		t6 = bits.RotateLeft32(t6^t10, int(12))
		t2 = t2 + t6
		t14 = bits.RotateLeft32(t14^t2, int(8))
		t10 = t10 + t14
		t6 = bits.RotateLeft32(t6^t10, int(7)) // column 2
		t3 = t3 + t7
		t15 = bits.RotateLeft32(t15^t3, int(16))
		t11 = t11 + t15
		t7 = bits.RotateLeft32(t7^t11, int(12))
		t3 = t3 + t7
		t15 = bits.RotateLeft32(t15^t3, int(8))
		t11 = t11 + t15
		t7 = bits.RotateLeft32(t7^t11, int(7)) // column 3
		t0 = t0 + t5
		t15 = bits.RotateLeft32(t15^t0, int(16))
		t10 = t10 + t15
		t5 = bits.RotateLeft32(t5^t10, int(12))
		t0 = t0 + t5
		t15 = bits.RotateLeft32(t15^t0, int(8))
		t10 = t10 + t15
		t5 = bits.RotateLeft32(t5^t10, int(7)) // diagonal 0
		t1 = t1 + t6
		t12 = bits.RotateLeft32(t12^t1, int(16))
		t11 = t11 + t12
		t6 = bits.RotateLeft32(t6^t11, int(12))
		t1 = t1 + t6
		t12 = bits.RotateLeft32(t12^t1, int(8))
		t11 = t11 + t12
		t6 = bits.RotateLeft32(t6^t11, int(7)) // diagonal 1
		t2 = t2 + t7
		t13 = bits.RotateLeft32(t13^t2, int(16))
		t8 = t8 + t13
		t7 = bits.RotateLeft32(t7^t8, int(12))
		t2 = t2 + t7
		t13 = bits.RotateLeft32(t13^t2, int(8))
		t8 = t8 + t13
		t7 = bits.RotateLeft32(t7^t8, int(7)) // diagonal 2
		t3 = t3 + t4
		t14 = bits.RotateLeft32(t14^t3, int(16))
		t9 = t9 + t14
		t4 = bits.RotateLeft32(t4^t9, int(12))
		t3 = t3 + t4
		t14 = bits.RotateLeft32(t14^t3, int(8))
		t9 = t9 + t14
		t4 = bits.RotateLeft32(t4^t9, int(7)) // diagonal 3
		goto _1
	_1:
		;
		i = i + 1
...
func crypto_chacha20_djb(tls *libc.TLS, cipher_text uintptr, plain_text uintptr, text_size size_t, key uintptr, nonce uintptr, ctr u64) (r u64) {
	...
	(**(**[16]u32)(__ccgo_up(bp)))[int32(13)] = uint32(ctr >> int32(32))
	...
	for {
		...
		if plain_text != libc.UintptrFromInt32(0) {
			j = uint64(libc.Int32FromInt32(0))
			for {
				if !(j < uint64(libc.Int32FromInt32(16))) {
					break
				}
			...
			j1 = uint64(libc.Int32FromInt32(0))
			for {
				if !(j1 < uint64(libc.Int32FromInt32(16))) {
					break
				}
				p1 = (**(**[16]u32)(__ccgo_up(bp + 64)))[j1] + (**(**[16]u32)(__ccgo_up(bp)))[j1]
				store32_le(cipher_text, p1)
				cipher_text = cipher_text + uintptr(4)
				goto _3
			_3:
				;
	...
	if text_size > uint64(0) {
		...
		chacha20_rounds(tls, bp+64, bp)
		i1 = uint64(libc.Int32FromInt32(0))
		for {
			if !(i1 < uint64(libc.Int32FromInt32(16))) {
				break
			}
			store32_le(bp+128+uintptr(i1*uint64(4)), (**(**[16]u32)(__ccgo_up(bp + 64)))[i1]+(**(**[16]u32)(__ccgo_up(bp)))[i1])
			goto _4
		_4:
			;
			i1 = i1 + 1
		}
		i2 = uint64(libc.Int32FromInt32(0))
		for {
			if !(i2 < text_size) {
				break
			}
		...
		crypto_wipe(bp+128, uint64(64))
	}
	ctr = uint64((**(**[16]u32)(__ccgo_up(bp)))[int32(12)]) + uint64((**(**[16]u32)(__ccgo_up(bp)))[int32(13)])<<int32(32) + libc.BoolUint64(text_size > uint64(0))
	crypto_wipe(bp+64, uint64(64))
	crypto_wipe(bp, uint64(64))
	return ctr
}
...
func crypto_chacha20_ietf(tls *libc.TLS, cipher_text uintptr, plain_text uintptr, text_size size_t, key uintptr, nonce uintptr, ctr u32) (r u32) {
	var big_ctr u64
	_ = big_ctr
	big_ctr = uint64(ctr) + uint64(load32_le(nonce))<<int32(32)
...
func poly_blocks(tls *libc.TLS, ctx uintptr, in uintptr, nb_blocks size_t, end uint32) {
	...
	rr0 = r0 >> int32(2) * uint32(5) // lose 2 bits...
	rr1 = r1>>int32(2) + r1          // rr1 == (r1 >> 2) * 5
	rr2 = r2>>int32(2) + r2          // rr1 == (r2 >> 2) * 5
	rr3 = r3>>int32(2) + r3          // rr1 == (r3 >> 2) * 5
	...
	for {
		...
		s0 = uint64(h0) + uint64(load32_le(in))
		in = in + uintptr(4)
		s1 = uint64(h1) + uint64(load32_le(in))
		in = in + uintptr(4)
		s2 = uint64(h2) + uint64(load32_le(in))
		in = in + uintptr(4)
		s3 = uint64(h3) + uint64(load32_le(in))
		in = in + uintptr(4)
		s4 = h4 + end
		...
		u5 = uint32(x3>>int32(32)) + x4 // u5 <= 7ffffff5
		u0 = uint64(u5>>int32(2)*uint32(5)) + x0&uint64(0xffffffff)
		u1 = uint64(uint32(u0>>int32(32))) + x1&uint64(0xffffffff) + x0>>int32(32)
		u2 = uint64(uint32(u1>>int32(32))) + x2&uint64(0xffffffff) + x1>>int32(32)
		u3 = uint64(uint32(u2>>int32(32))) + x3&uint64(0xffffffff) + x2>>int32(32)
		u4 = uint32(u3>>int32(32)) + u5&uint32(3) // u4 <= 4
		// Update the hash
...
func crypto_poly1305_init(tls *libc.TLS, ctx uintptr, key uintptr) {
	...
	_i_ = uint64(libc.Int32FromInt32(0))
	for {
		if !(_i_ < uint64(libc.Int32FromInt32(5))) {
			break
		}
	...
	i = uint64(libc.Int32FromInt32(0))
	for {
		if !(i < uint64(libc.Int32FromInt32(1))) {
			break
		}
	...
	i1 = uint64(libc.Int32FromInt32(1))
	for {
		if !(i1 < uint64(libc.Int32FromInt32(4))) {
			break
		}
...
func crypto_poly1305_update(tls *libc.TLS, ctx uintptr, message uintptr, message_size size_t) {
	...
	if gap((*crypto_poly1305_ctx)(unsafe.Pointer(ctx)).Fc_idx, uint64(16)) <= message_size {
		v1 = gap((*crypto_poly1305_ctx)(unsafe.Pointer(ctx)).Fc_idx, uint64(16))
	} else {
		v1 = message_size
	}
...
func crypto_poly1305_final(tls *libc.TLS, ctx uintptr, mac uintptr) {
	...
	i = uint64(libc.Int32FromInt32(0))
	for {
		if !(i < uint64(libc.Int32FromInt32(4))) {
			break
		}
	...
	c = c >> int32(2) * uint64(5) // shift the carry back to the beginning
	...
	for {
		...
		store32_le(mac+uintptr(i1*uint64(4)), uint32(c))
		c = c >> int32(32)
		goto _3
	_3:
		;
...
func crypto_blake2b_keyed_init(tls *libc.TLS, ctx uintptr, hash_size size_t, key uintptr, key_size size_t) {
	...
	_i_ = uint64(libc.Int32FromInt32(0))
	for {
		if !(_i_ < uint64(libc.Int32FromInt32(8))) {
			break
		}
	...
	**(**uint64_t)(__ccgo_up(ctx)) ^= uint64(0x01010000) ^ key_size<<int32(8) ^ hash_size
	...
	**(**uint64_t)(__ccgo_up(ctx + 64 + 1*8)) = uint64(0) // beginning of the input, no offset
	...
	_i_1 = uint64(libc.Int32FromInt32(0))
	for {
		if !(_i_1 < uint64(libc.Int32FromInt32(16))) {
			break
		}
	...
	if key_size > uint64(0) {
		**(**[128]u8)(__ccgo_up(bp)) = [128]u8{}
		_i_2 = uint64(libc.Int32FromInt32(0))
		for {
			if !(_i_2 < key_size) {
				break
			}
...
func crypto_blake2b_update(tls *libc.TLS, ctx uintptr, message uintptr, message_size size_t) {
	...
	if (*crypto_blake2b_ctx)(unsafe.Pointer(ctx)).Finput_idx&uint64(7) != uint64(0) {
		if gap((*crypto_blake2b_ctx)(unsafe.Pointer(ctx)).Finput_idx, uint64(8)) <= message_size {
			v1 = gap((*crypto_blake2b_ctx)(unsafe.Pointer(ctx)).Finput_idx, uint64(8))
		} else {
			v1 = message_size
		}
		nb_bytes = v1
	...
	if (*crypto_blake2b_ctx)(unsafe.Pointer(ctx)).Finput_idx&uint64(127) != uint64(0) {
		if gap((*crypto_blake2b_ctx)(unsafe.Pointer(ctx)).Finput_idx, uint64(128)) <= message_size {
			v1 = gap((*crypto_blake2b_ctx)(unsafe.Pointer(ctx)).Finput_idx, uint64(128))
		} else {
			v1 = message_size
		}
		nb_words = v1 >> int32(3)
		load64_le_buf(tls, ctx+80+uintptr((*crypto_blake2b_ctx)(unsafe.Pointer(ctx)).Finput_idx>>int32(3))*8, message, nb_words)
	...
	if message_size != uint64(0) {
		...
		if (*crypto_blake2b_ctx)(unsafe.Pointer(ctx)).Finput_idx == uint64(0) {
			_i_ = uint64(libc.Int32FromInt32(0))
			for {
				if !(_i_ < uint64(libc.Int32FromInt32(16))) {
					break
				}
...
func crypto_blake2b_final(tls *libc.TLS, ctx uintptr, hash uintptr) {
	...
	if (*crypto_blake2b_ctx)(unsafe.Pointer(ctx)).Fhash_size <= uint64(libc.Int32FromInt32(64)) {
		v1 = (*crypto_blake2b_ctx)(unsafe.Pointer(ctx)).Fhash_size
	} else {
		v1 = uint64(libc.Int32FromInt32(64))
	...
	for {
		...
		**(**u8)(__ccgo_up(hash + uintptr(i))) = uint8(**(**uint64_t)(__ccgo_up(ctx + uintptr(i>>int32(3))*8)) >> (uint64(8) * (i & uint64(7))) & uint64(0xff))
		goto _2
	_2:
		;
		i = i + 1
	}
	crypto_wipe(ctx, uint64(224))
}
...
func copy_block(o uintptr, in uintptr) {
	var i size_t
	_ = i
	i = uint64(libc.Int32FromInt32(0))
	for {
		if !(i < uint64(libc.Int32FromInt32(128))) {
			break
		}
...
func xor_block(o uintptr, in uintptr) {
	var i size_t
	_ = i
	i = uint64(libc.Int32FromInt32(0))
	for {
...
func extended_hash(tls *libc.TLS, digest uintptr, digest_size u32, input uintptr, input_size u32) {
	...
	if digest_size <= uint32(libc.Int32FromInt32(64)) {
		v1 = digest_size
	} else {
	...
	if digest_size > uint32(64) {
		...
		r = uint32((uint64(digest_size)+uint64(31))>>int32(5)) - uint32(2)
		i = uint32(1)
		in = uint32(0)
		out = uint32(32)
		for i < r {
...
func g_rounds(tls *libc.TLS, b uintptr) {
	...
	for {
		...
		**(**u64)(__ccgo_up(b + uintptr(i+int32(12))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i+int32(12))*8)), uint64(32))
		...
		**(**u64)(__ccgo_up(b + uintptr(i+int32(4))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i+int32(4))*8)), uint64(24))
		**(**u64)(__ccgo_up(b + uintptr(i)*8)) += **(**u64)(__ccgo_up(b + uintptr(i+int32(4))*8)) + uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i)*8))))*uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i+int32(4))*8))))<<int32(1)
		**(**u64)(__ccgo_up(b + uintptr(i+int32(12))*8)) ^= **(**u64)(__ccgo_up(b + uintptr(i)*8))
		**(**u64)(__ccgo_up(b + uintptr(i+int32(12))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i+int32(12))*8)), uint64(16))
		**(**u64)(__ccgo_up(b + uintptr(i+int32(8))*8)) += **(**u64)(__ccgo_up(b + uintptr(i+int32(12))*8)) + uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i+int32(8))*8))))*uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i+int32(12))*8))))<<int32(1)
		**(**u64)(__ccgo_up(b + uintptr(i+int32(4))*8)) ^= **(**u64)(__ccgo_up(b + uintptr(i+int32(8))*8))
		**(**u64)(__ccgo_up(b + uintptr(i+int32(4))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i+int32(4))*8)), uint64(63))
		...
		**(**u64)(__ccgo_up(b + uintptr(i+int32(13))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i+int32(13))*8)), uint64(32))
		...
		**(**u64)(__ccgo_up(b + uintptr(i+int32(5))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i+int32(5))*8)), uint64(24))
		**(**u64)(__ccgo_up(b + uintptr(i+int32(1))*8)) += **(**u64)(__ccgo_up(b + uintptr(i+int32(5))*8)) + uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i+int32(1))*8))))*uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i+int32(5))*8))))<<int32(1)
		**(**u64)(__ccgo_up(b + uintptr(i+int32(13))*8)) ^= **(**u64)(__ccgo_up(b + uintptr(i+int32(1))*8))
		**(**u64)(__ccgo_up(b + uintptr(i+int32(13))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i+int32(13))*8)), uint64(16))
		**(**u64)(__ccgo_up(b + uintptr(i+int32(9))*8)) += **(**u64)(__ccgo_up(b + uintptr(i+int32(13))*8)) + uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i+int32(9))*8))))*uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i+int32(13))*8))))<<int32(1)
		**(**u64)(__ccgo_up(b + uintptr(i+int32(5))*8)) ^= **(**u64)(__ccgo_up(b + uintptr(i+int32(9))*8))
		**(**u64)(__ccgo_up(b + uintptr(i+int32(5))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i+int32(5))*8)), uint64(63))
		...
		**(**u64)(__ccgo_up(b + uintptr(i+int32(14))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i+int32(14))*8)), uint64(32))
		...
		**(**u64)(__ccgo_up(b + uintptr(i+int32(6))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i+int32(6))*8)), uint64(24))
		**(**u64)(__ccgo_up(b + uintptr(i+int32(2))*8)) += **(**u64)(__ccgo_up(b + uintptr(i+int32(6))*8)) + uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i+int32(2))*8))))*uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i+int32(6))*8))))<<int32(1)
		**(**u64)(__ccgo_up(b + uintptr(i+int32(14))*8)) ^= **(**u64)(__ccgo_up(b + uintptr(i+int32(2))*8))
		**(**u64)(__ccgo_up(b + uintptr(i+int32(14))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i+int32(14))*8)), uint64(16))
		**(**u64)(__ccgo_up(b + uintptr(i+int32(10))*8)) += **(**u64)(__ccgo_up(b + uintptr(i+int32(14))*8)) + uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i+int32(10))*8))))*uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i+int32(14))*8))))<<int32(1)
		**(**u64)(__ccgo_up(b + uintptr(i+int32(6))*8)) ^= **(**u64)(__ccgo_up(b + uintptr(i+int32(10))*8))
		**(**u64)(__ccgo_up(b + uintptr(i+int32(6))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i+int32(6))*8)), uint64(63))
		...
		**(**u64)(__ccgo_up(b + uintptr(i+int32(15))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i+int32(15))*8)), uint64(32))
		...
		**(**u64)(__ccgo_up(b + uintptr(i+int32(7))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i+int32(7))*8)), uint64(24))
		**(**u64)(__ccgo_up(b + uintptr(i+int32(3))*8)) += **(**u64)(__ccgo_up(b + uintptr(i+int32(7))*8)) + uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i+int32(3))*8))))*uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i+int32(7))*8))))<<int32(1)
		**(**u64)(__ccgo_up(b + uintptr(i+int32(15))*8)) ^= **(**u64)(__ccgo_up(b + uintptr(i+int32(3))*8))
		**(**u64)(__ccgo_up(b + uintptr(i+int32(15))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i+int32(15))*8)), uint64(16))
		**(**u64)(__ccgo_up(b + uintptr(i+int32(11))*8)) += **(**u64)(__ccgo_up(b + uintptr(i+int32(15))*8)) + uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i+int32(11))*8))))*uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i+int32(15))*8))))<<int32(1)
		**(**u64)(__ccgo_up(b + uintptr(i+int32(7))*8)) ^= **(**u64)(__ccgo_up(b + uintptr(i+int32(11))*8))
		**(**u64)(__ccgo_up(b + uintptr(i+int32(7))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i+int32(7))*8)), uint64(63))
	...
	for {
		...
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(96))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i1+int32(96))*8)), uint64(32))
		...
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(32))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i1+int32(32))*8)), uint64(24))
		**(**u64)(__ccgo_up(b + uintptr(i1)*8)) += **(**u64)(__ccgo_up(b + uintptr(i1+int32(32))*8)) + uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i1)*8))))*uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i1+int32(32))*8))))<<int32(1)
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(96))*8)) ^= **(**u64)(__ccgo_up(b + uintptr(i1)*8))
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(96))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i1+int32(96))*8)), uint64(16))
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(64))*8)) += **(**u64)(__ccgo_up(b + uintptr(i1+int32(96))*8)) + uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i1+int32(64))*8))))*uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i1+int32(96))*8))))<<int32(1)
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(32))*8)) ^= **(**u64)(__ccgo_up(b + uintptr(i1+int32(64))*8))
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(32))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i1+int32(32))*8)), uint64(63))
		...
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(97))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i1+int32(97))*8)), uint64(32))
		...
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(33))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i1+int32(33))*8)), uint64(24))
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(1))*8)) += **(**u64)(__ccgo_up(b + uintptr(i1+int32(33))*8)) + uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i1+int32(1))*8))))*uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i1+int32(33))*8))))<<int32(1)
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(97))*8)) ^= **(**u64)(__ccgo_up(b + uintptr(i1+int32(1))*8))
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(97))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i1+int32(97))*8)), uint64(16))
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(65))*8)) += **(**u64)(__ccgo_up(b + uintptr(i1+int32(97))*8)) + uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i1+int32(65))*8))))*uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i1+int32(97))*8))))<<int32(1)
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(33))*8)) ^= **(**u64)(__ccgo_up(b + uintptr(i1+int32(65))*8))
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(33))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i1+int32(33))*8)), uint64(63))
		...
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(112))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i1+int32(112))*8)), uint64(32))
		...
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(48))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i1+int32(48))*8)), uint64(24))
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(16))*8)) += **(**u64)(__ccgo_up(b + uintptr(i1+int32(48))*8)) + uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i1+int32(16))*8))))*uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i1+int32(48))*8))))<<int32(1)
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(112))*8)) ^= **(**u64)(__ccgo_up(b + uintptr(i1+int32(16))*8))
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(112))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i1+int32(112))*8)), uint64(16))
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(80))*8)) += **(**u64)(__ccgo_up(b + uintptr(i1+int32(112))*8)) + uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i1+int32(80))*8))))*uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i1+int32(112))*8))))<<int32(1)
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(48))*8)) ^= **(**u64)(__ccgo_up(b + uintptr(i1+int32(80))*8))
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(48))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i1+int32(48))*8)), uint64(63))
		...
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(113))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i1+int32(113))*8)), uint64(32))
		...
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(49))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i1+int32(49))*8)), uint64(24))
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(17))*8)) += **(**u64)(__ccgo_up(b + uintptr(i1+int32(49))*8)) + uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i1+int32(17))*8))))*uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i1+int32(49))*8))))<<int32(1)
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(113))*8)) ^= **(**u64)(__ccgo_up(b + uintptr(i1+int32(17))*8))
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(113))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i1+int32(113))*8)), uint64(16))
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(81))*8)) += **(**u64)(__ccgo_up(b + uintptr(i1+int32(113))*8)) + uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i1+int32(81))*8))))*uint64(uint32(**(**u64)(__ccgo_up(b + uintptr(i1+int32(113))*8))))<<int32(1)
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(49))*8)) ^= **(**u64)(__ccgo_up(b + uintptr(i1+int32(81))*8))
		**(**u64)(__ccgo_up(b + uintptr(i1+int32(49))*8)) = rotr64(**(**u64)(__ccgo_up(b + uintptr(i1+int32(49))*8)), uint64(63))
...
func crypto_argon2(tls *libc.TLS, hash uintptr, hash_size u32, work_area uintptr, config crypto_argon2_config, inputs crypto_argon2_inputs, extras crypto_argon2_extras) {
	...
	l = uint32(libc.Int32FromInt32(0))
	for {
		if !(l < config.Fnb_lanes) {
			break
		}
		i = uint32(libc.Int32FromInt32(0))
		for {
			if !(i < uint32(libc.Int32FromInt32(2))) {
				break
			}
			store32_le(bp+uintptr(64), i) // first  additional word
			store32_le(bp+uintptr(68), l) // second additional word
	...
	crypto_wipe(bp, uint64(72))
	crypto_wipe(bp+296, uint64(1024))
	...
	pass = uint32(libc.Int32FromInt32(0))
	for {
		if !(pass < config.Fnb_passes) {
			break
		}
		slice = uint32(libc.Int32FromInt32(0))
		for {
			if !(slice < uint32(libc.Int32FromInt32(4))) {
				break
			}
			...
			segment = uint32(libc.Int32FromInt32(0))
			for {
				...
				for {
					...
					if constant_time != 0 {
						if block == pass_offset || block%uint32(128) == uint32(0) {
							...
							_i_ = uint64(libc.Int32FromInt32(0))
							for {
								if !(_i_ < uint64(libc.Int32FromInt32(128))) {
									break
								}
							...
							**(**u64)(__ccgo_up(bp + 2344 + 6*8)) = uint64(index_ctr)
							...
							// ... then shuffle it
							copy_block(bp+1320, bp+2344)
							g_rounds(tls, bp+2344)
							xor_block(bp+2344, bp+1320)
							copy_block(bp+1320, bp+2344)
							g_rounds(tls, bp+2344)
							xor_block(bp+2344, bp+1320)
						}
					...
					if pass == uint32(0) && slice == uint32(0) {
						...
						v12 = uint32(index_seed>>int32(32)) % config.Fnb_lanes
					}
					lane = v12
					if lane == segment {
						v13 = block - uint32(1)
						...
						if block == uint32(0) {
							v14 = libc.Uint32FromInt32(-int32(1))
						} else {
							v14 = uint32(0)
						}
						v13 = v14
					...
					z = uint64(window_size-uint32(1)) - y
					...
					copy_block(bp+1320, previous)
					xor_block(bp+1320, reference)
					if pass == uint32(0) {
						copy_block(current, bp+1320)
					} else {
						xor_block(current, bp+1320)
					}
	...
	_i_1 = uint64(libc.Int32FromInt32(0))
	for {
		if !(_i_1 < uint64(libc.Int32FromInt32(128))) {
			break
		}
	...
	lane1 = uint32(libc.Int32FromInt32(1))
	for {
	...
	_i_2 = uint64(libc.Int32FromInt32(0))
	for {
		if !(_i_2 < uint64(uint32(128)*nb_blocks)) {
			break
		}
	...
	crypto_wipe(bp+3368, uint64(1024))
}
...
func fe_0(h uintptr) {
	...
	_i_ = uint64(libc.Int32FromInt32(0))
	for {
		if !(_i_ < uint64(libc.Int32FromInt32(10))) {
			break
		}
...
func fe_1(h uintptr) {
	...
	**(**i32)(__ccgo_up(h)) = int32(1)
	_i_ = uint64(libc.Int32FromInt32(0))
	for {
		if !(_i_ < uint64(libc.Int32FromInt32(9))) {
			break
		}
...
func fe_copy(h uintptr, f uintptr) {
	var i size_t
	_ = i
	i = uint64(libc.Int32FromInt32(0))
	for {
...
func fe_neg(h uintptr, f uintptr) {
	var i size_t
	_ = i
	i = uint64(libc.Int32FromInt32(0))
	for {
...
func fe_add(h uintptr, f uintptr, g uintptr) {
	var i size_t
	_ = i
	i = uint64(libc.Int32FromInt32(0))
	for {
...
func fe_sub(h uintptr, f uintptr, g uintptr) {
	var i size_t
	_ = i
	i = uint64(libc.Int32FromInt32(0))
	for {
...
func fe_cswap(f uintptr, g uintptr, b int32) {
...
func fe_ccopy(f uintptr, g uintptr, b int32) {
	var mask, x0, x1, x2, x3, x4, x5, x6, x7, x8, x9 i32
	_, _, _, _, _, _, _, _, _, _, _ = mask, x0, x1, x2, x3, x4, x5, x6, x7, x8, x9
	mask = -b // -1 = 0xffffffff
	x0 = (**(**i32)(__ccgo_up(f)) ^ **(**i32)(__ccgo_up(g))) & mask
...
func fe_frombytes_mask(tls *libc.TLS, h uintptr, s uintptr, nb_mask uint32) {
	...
	mask = uint32(int32(0xffffff) >> nb_mask)
	t0 = libc.Int64FromUint32(load32_le(s))                         // t0 < 2^32
	t1 = libc.Int64FromUint32(load24_le(s+uintptr(4)) << int32(6))  // t1 < 2^30
	t2 = libc.Int64FromUint32(load24_le(s+uintptr(7)) << int32(5))  // t2 < 2^29
	t3 = libc.Int64FromUint32(load24_le(s+uintptr(10)) << int32(3)) // t3 < 2^27
	t4 = libc.Int64FromUint32(load24_le(s+uintptr(13)) << int32(2)) // t4 < 2^26
	t5 = libc.Int64FromUint32(load32_le(s + uintptr(16)))           // t5 < 2^32
	t6 = libc.Int64FromUint32(load24_le(s+uintptr(20)) << int32(7)) // t6 < 2^31
	t7 = libc.Int64FromUint32(load24_le(s+uintptr(23)) << int32(5)) // t7 < 2^29
	t8 = libc.Int64FromUint32(load24_le(s+uintptr(26)) << int32(4)) // t8 < 2^28
	t9 = libc.Int64FromUint32(load24_le(s+uintptr(29)) & mask << int32(2))
	c = (t0 + libc.Int64FromInt32(1)<<int32(25)) >> int32(26)
	t0 = t0 - c*(libc.Int64FromInt32(1)<<int32(26))
	t1 = t1 + c
	c = (t4 + libc.Int64FromInt32(1)<<int32(25)) >> int32(26)
	t4 = t4 - c*(libc.Int64FromInt32(1)<<int32(26))
	t5 = t5 + c
	c = (t1 + libc.Int64FromInt32(1)<<int32(24)) >> int32(25)
	t1 = t1 - c*(libc.Int64FromInt32(1)<<int32(25))
	t2 = t2 + c
	c = (t5 + libc.Int64FromInt32(1)<<int32(24)) >> int32(25)
	t5 = t5 - c*(libc.Int64FromInt32(1)<<int32(25))
	t6 = t6 + c
	c = (t2 + libc.Int64FromInt32(1)<<int32(25)) >> int32(26)
	t2 = t2 - c*(libc.Int64FromInt32(1)<<int32(26))
	t3 = t3 + c
	c = (t6 + libc.Int64FromInt32(1)<<int32(25)) >> int32(26)
	t6 = t6 - c*(libc.Int64FromInt32(1)<<int32(26))
	t7 = t7 + c
	c = (t3 + libc.Int64FromInt32(1)<<int32(24)) >> int32(25)
	t3 = t3 - c*(libc.Int64FromInt32(1)<<int32(25))
	t4 = t4 + c
	c = (t7 + libc.Int64FromInt32(1)<<int32(24)) >> int32(25)
	t7 = t7 - c*(libc.Int64FromInt32(1)<<int32(25))
	t8 = t8 + c
	c = (t4 + libc.Int64FromInt32(1)<<int32(25)) >> int32(26)
	t4 = t4 - c*(libc.Int64FromInt32(1)<<int32(26))
	t5 = t5 + c
	c = (t8 + libc.Int64FromInt32(1)<<int32(25)) >> int32(26)
	t8 = t8 - c*(libc.Int64FromInt32(1)<<int32(26))
	t9 = t9 + c
	c = (t9 + libc.Int64FromInt32(1)<<int32(24)) >> int32(25)
	t9 = t9 - c*(libc.Int64FromInt32(1)<<int32(25))
	t0 = t0 + c*int64(19)
	c = (t0 + libc.Int64FromInt32(1)<<int32(25)) >> int32(26)
	t0 = t0 - c*(libc.Int64FromInt32(1)<<int32(26))
	t1 = t1 + c
...
func fe_tobytes(tls *libc.TLS, s uintptr, h uintptr) {
	...
	q = (int32(19)*(**(**[10]i32)(__ccgo_up(bp)))[int32(9)] + int32(1)<<int32(24)) >> int32(25)
	//                 |t9|                    < 1.1 * 2^24
	...
	i = uint64(libc.Int32FromInt32(0))
	for {
		if !(i < uint64(libc.Int32FromInt32(5))) {
			break
		}
	...
	store32_le(s+uintptr(0), uint32((**(**[10]i32)(__ccgo_up(bp)))[0])>>int32(0)|uint32((**(**[10]i32)(__ccgo_up(bp)))[int32(1)])<<int32(26))
	store32_le(s+uintptr(4), uint32((**(**[10]i32)(__ccgo_up(bp)))[int32(1)])>>int32(6)|uint32((**(**[10]i32)(__ccgo_up(bp)))[int32(2)])<<int32(19))
	store32_le(s+uintptr(8), uint32((**(**[10]i32)(__ccgo_up(bp)))[int32(2)])>>int32(13)|uint32((**(**[10]i32)(__ccgo_up(bp)))[int32(3)])<<int32(13))
	store32_le(s+uintptr(12), uint32((**(**[10]i32)(__ccgo_up(bp)))[int32(3)])>>int32(19)|uint32((**(**[10]i32)(__ccgo_up(bp)))[int32(4)])<<int32(6))
	store32_le(s+uintptr(16), uint32((**(**[10]i32)(__ccgo_up(bp)))[int32(5)])>>int32(0)|uint32((**(**[10]i32)(__ccgo_up(bp)))[int32(6)])<<int32(25))
	store32_le(s+uintptr(20), uint32((**(**[10]i32)(__ccgo_up(bp)))[int32(6)])>>int32(7)|uint32((**(**[10]i32)(__ccgo_up(bp)))[int32(7)])<<int32(19))
	store32_le(s+uintptr(24), uint32((**(**[10]i32)(__ccgo_up(bp)))[int32(7)])>>int32(13)|uint32((**(**[10]i32)(__ccgo_up(bp)))[int32(8)])<<int32(12))
	store32_le(s+uintptr(28), uint32((**(**[10]i32)(__ccgo_up(bp)))[int32(8)])>>int32(20)|uint32((**(**[10]i32)(__ccgo_up(bp)))[int32(9)])<<int32(6))
	crypto_wipe(bp, uint64(40))
}
...
func fe_mul_small(h uintptr, f uintptr, g i32) {
	var c, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9 i64
...
//	//   |g0|, |g2|, |g4|, |g6|, |g8|  <  1.65 * 2^26
//	//   |g1|, |g3|, |g5|, |g7|, |g9|  <  1.65 * 2^25
func fe_mul(h uintptr, f uintptr, g uintptr) {
...
func fe_sq(h uintptr, f uintptr) {
	var c, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9 i64
...
func invsqrt(tls *libc.TLS, isr uintptr, x uintptr) (r int32) {
	...
	fe_sq(bp+40, bp)
	fe_sq(bp+40, bp+40)
	fe_mul(bp+40, x, bp+40)
	fe_mul(bp, bp, bp+40)
	fe_sq(bp, bp)
	fe_mul(bp, bp+40, bp)
	fe_sq(bp+40, bp)
	i = uint64(libc.Int32FromInt32(1))
	for {
		if !(i < uint64(libc.Int32FromInt32(5))) {
			break
		}
	...
	i1 = uint64(libc.Int32FromInt32(1))
	for {
		if !(i1 < uint64(libc.Int32FromInt32(10))) {
			break
		}
		fe_sq(bp+40, bp+40)
		goto _2
	...
	fe_mul(bp+40, bp+40, bp)
	fe_sq(bp+80, bp+40)
	i2 = uint64(libc.Int32FromInt32(1))
	for {
		if !(i2 < uint64(libc.Int32FromInt32(20))) {
			break
		}
		fe_sq(bp+80, bp+80)
		goto _3
	...
	fe_mul(bp+40, bp+80, bp+40)
	fe_sq(bp+40, bp+40)
	i3 = uint64(libc.Int32FromInt32(1))
	for {
		if !(i3 < uint64(libc.Int32FromInt32(10))) {
			break
		}
		fe_sq(bp+40, bp+40)
		goto _4
	...
	fe_mul(bp, bp+40, bp)
	fe_sq(bp+40, bp)
	i4 = uint64(libc.Int32FromInt32(1))
	for {
		if !(i4 < uint64(libc.Int32FromInt32(50))) {
			break
		}
		fe_sq(bp+40, bp+40)
		goto _5
	...
	fe_mul(bp+40, bp+40, bp)
	fe_sq(bp+80, bp+40)
	i5 = uint64(libc.Int32FromInt32(1))
	for {
		if !(i5 < uint64(libc.Int32FromInt32(100))) {
			break
		}
		fe_sq(bp+80, bp+80)
		goto _6
	...
	fe_mul(bp+40, bp+80, bp+40)
	fe_sq(bp+40, bp+40)
	i6 = uint64(libc.Int32FromInt32(1))
	for {
		if !(i6 < uint64(libc.Int32FromInt32(50))) {
			break
		}
		fe_sq(bp+40, bp+40)
		goto _7
	...
	fe_mul(bp, bp+40, bp)
	fe_sq(bp, bp)
	i7 = uint64(libc.Int32FromInt32(1))
	for {
		if !(i7 < uint64(libc.Int32FromInt32(2))) {
			break
		}
		fe_sq(bp, bp)
		goto _8
	...
	fe_neg(check, uintptr(unsafe.Pointer(&sqrtm1)))
	ms = fe_isequal(tls, quartic, check)
	// if quartic == -1 or sqrt(-1)
	// then  isr = x^((p-1)/4) * sqrt(-1)
	// else  isr = x^((p-1)/4)
	fe_mul(isr, bp, uintptr(unsafe.Pointer(&sqrtm1)))
	fe_ccopy(isr, bp, int32(1)-(m1|ms))
	crypto_wipe(bp, uint64(40))
	crypto_wipe(bp+40, uint64(40))
	crypto_wipe(bp+80, uint64(40))
	return p1 | m1 | z0
}
...
func crypto_eddsa_trim_scalar(out uintptr, in uintptr) {
	var _i_ size_t
	var v2 uintptr
	_, _ = _i_, v2
	_i_ = uint64(libc.Int32FromInt32(0))
	for {
		if !(_i_ < uint64(libc.Int32FromInt32(32))) {
			break
		}
	...
	v2 = out
	*(*u8)(unsafe.Pointer(v2)) = u8(int32(*(*u8)(unsafe.Pointer(v2))) & int32(248))
	v2 = out + 31
	*(*u8)(unsafe.Pointer(v2)) = u8(int32(*(*u8)(unsafe.Pointer(v2))) & int32(127))
	v2 = out + 31
	*(*u8)(unsafe.Pointer(v2)) = u8(int32(*(*u8)(unsafe.Pointer(v2))) | int32(64))
}

// C documentation
//
//	// get bit from scalar at position i
func scalar_bit(s uintptr, i int32) (r int32) {
	if i < 0 {
		return 0
...
func scalarmult(tls *libc.TLS, q uintptr, scalar uintptr, p uintptr, nb_bits int32) {
	...
	fe_1(bp + 40)
	fe_0(bp + 80) // "zero" point
	fe_copy(bp+120, bp)
	fe_1(bp + 160) // "one"  point
	swap = 0
	pos = nb_bits - int32(1)
	for {
		if !(pos >= 0) {
		...
		fe_cswap(bp+40, bp+120, swap)
		fe_cswap(bp+80, bp+160, swap)
		swap = b // anticipates one last swap after the loop
		// Montgomery ladder step: replaces (P2, P3) by (P2*2, P2+P3)
		// with differential addition
		fe_sub(bp+200, bp+120, bp+160)
		fe_sub(bp+240, bp+40, bp+80)
		fe_add(bp+40, bp+40, bp+80)
		fe_add(bp+80, bp+120, bp+160)
		fe_mul(bp+160, bp+200, bp+40)
		fe_mul(bp+80, bp+80, bp+240)
		fe_sq(bp+200, bp+240)
		fe_sq(bp+240, bp+40)
		fe_add(bp+120, bp+160, bp+80)
		fe_sub(bp+80, bp+160, bp+80)
		fe_mul(bp+40, bp+240, bp+200)
		fe_sub(bp+240, bp+240, bp+200)
		fe_sq(bp+80, bp+80)
		fe_mul_small(bp+160, bp+240, int32(121666))
		fe_sq(bp+120, bp+120)
		fe_add(bp+200, bp+200, bp+160)
		fe_mul(bp+160, bp, bp+80)
		fe_mul(bp+80, bp+240, bp+200)
		goto _1
	_1:
		;
		pos = pos - 1
	...
	fe_mul(bp+40, bp+40, bp+80)
	fe_tobytes(tls, q, bp+40)
	crypto_wipe(bp, uint64(40))
	crypto_wipe(bp+40, uint64(40))
	crypto_wipe(bp+80, uint64(40))
	crypto_wipe(bp+200, uint64(40))
	crypto_wipe(bp+120, uint64(40))
	crypto_wipe(bp+160, uint64(40))
	crypto_wipe(bp+240, uint64(40))
}
...
func crypto_x25519(tls *libc.TLS, raw_shared_secret uintptr, your_secret_key uintptr, their_public_key uintptr) {
	...
	crypto_eddsa_trim_scalar(bp, your_secret_key)
...
//
//	//  p = a*b + p
func multiply(p uintptr, a uintptr, b uintptr) {
	var carry u64
	var i, j size_t
	_, _, _ = carry, i, j
	i = uint64(libc.Int32FromInt32(0))
	for {
		if !(i < uint64(libc.Int32FromInt32(8))) {
			break
		}
		carry = uint64(0)
		j = uint64(libc.Int32FromInt32(0))
		for {
			if !(j < uint64(libc.Int32FromInt32(8))) {
				break
			}
...
func is_above_l(x uintptr) (r int32) {
	var carry u64
	var i size_t
	_, _ = carry, i
	...
	for {
		...
		carry = carry + (uint64(**(**u32)(__ccgo_up(x + uintptr(i)*4))) + uint64(^L[i]&uint32(0xffffffff)))
		carry = carry >> uint64(32)
		goto _1
	_1:
		;
...
func mod_l(tls *libc.TLS, reduced uintptr, x uintptr) {
	...
	**(**[25]u32)(__ccgo_up(bp)) = [25]u32{}
	i = uint64(libc.Int32FromInt32(0))
	for {
		if !(i < uint64(libc.Int32FromInt32(9))) {
			break
		}
		carry = uint64(0)
		j = uint64(libc.Int32FromInt32(0))
	...
	i1 = uint64(libc.Int32FromInt32(0))
	for {
		if !(i1 < uint64(libc.Int32FromInt32(8))) {
			break
		}
		carry1 = uint64(0)
		j1 = uint64(libc.Int32FromInt32(0))
	...
	i2 = uint64(libc.Int32FromInt32(0))
	for {
		if !(i2 < uint64(libc.Int32FromInt32(8))) {
			break
		}
		carry2 = carry2 + (uint64(**(**u32)(__ccgo_up(x + uintptr(i2)*4))) + uint64(^(**(**[25]u32)(__ccgo_up(bp)))[i2]&uint32(0xffffffff)))
...
func ge_tobytes(tls *libc.TLS, s uintptr, h uintptr) {
	...
	fe_mul(bp+40, h, bp)
	fe_mul(bp+80, h+40, bp)
	fe_tobytes(tls, s, bp+80)
	v1 = s + 31
	*(*u8)(unsafe.Pointer(v1)) = u8(int32(*(*u8)(unsafe.Pointer(v1))) ^ libc.Int32FromUint8(libc.Uint8FromInt32(fe_isodd(tls, bp+40)))<<int32(7))
	crypto_wipe(bp, uint64(40))
	crypto_wipe(bp+40, uint64(40))
	crypto_wipe(bp+80, uint64(40))
}
...
func ge_frombytes_neg_vartime(tls *libc.TLS, h uintptr, s uintptr) (r int32) {
	...
	fe_1(h + 80)
	fe_sq(h+120, h+40)                            // t =   y^2
	fe_mul(h, h+120, uintptr(unsafe.Pointer(&d))) // x = d*y^2
	fe_sub(h+120, h+120, h+80)                    // t =   y^2 - 1
	fe_add(h, h, h+80)                            // x = d*y^2 + 1
	fe_mul(h, h+120, h)                           // x = (y^2 - 1) * (d*y^2 + 1)
	is_square = invsqrt(tls, h, h)
	if !(is_square != 0) {
		return -int32(1) // Not on the curve, abort
	}
	fe_mul(h, h+120, h) // x = sqrt((y^2 - 1) / (d*y^2 + 1))
...
func ge_cache(tls *libc.TLS, c uintptr, p uintptr) {
	...
	fe_sub(c+40, p+40, p)
	fe_copy(c+80, p+80)
	fe_mul(c+120, p+120, uintptr(unsafe.Pointer(&D2)))
}
...
func ge_add(tls *libc.TLS, s uintptr, p uintptr, q uintptr) {
	...
	fe_sub(bp+40, p+40, p)
	fe_mul(bp, bp, q)
	fe_mul(bp+40, bp+40, q+40)
	fe_add(s+40, bp, bp+40)
	fe_sub(s, bp, bp+40)
	fe_add(s+80, p+80, p+80)
	fe_mul(s+80, s+80, q+80)
	fe_mul(s+120, p+120, q+120)
	fe_add(bp, s+80, s+120)
	fe_sub(bp+40, s+80, s+120)
	fe_mul(s+120, s, s+40)
	fe_mul(s, s, bp+40)
	fe_mul(s+40, s+40, bp)
	fe_mul(s+80, bp, bp+40)
}
...
func ge_double(tls *libc.TLS, s uintptr, p uintptr, q uintptr) {
	fe_sq(q, p)
	fe_sq(q+40, p+40)
	fe_sq(q+80, p+80)                  // qZ = pZ^2
	fe_mul_small(q+80, q+80, int32(2)) // qZ = pZ^2 * 2
	fe_add(q+120, p, p+40)
	fe_sq(s+120, q+120)
	fe_add(q+120, q+40, q)
	fe_sub(q+40, q+40, q)
	fe_sub(q, s+120, q+120)
	fe_sub(q+80, q+80, q+40)
	fe_mul(s, q, q+80)
	fe_mul(s+40, q+120, q+40)
	fe_mul(s+80, q+40, q+80)
	fe_mul(s+120, q, q+120)
}
...
func slide_init(tls *libc.TLS, ctx uintptr, scalar uintptr) {
	...
	(*slide_ctx)(unsafe.Pointer(ctx)).Fnext_check = libc.Uint8FromInt32(i + int32(1))
...
func slide_step(tls *libc.TLS, ctx uintptr, width int32, i int32, scalar uintptr) (r int32) {
	...
	if i == libc.Int32FromUint8((*slide_ctx)(unsafe.Pointer(ctx)).Fnext_check) {
		if scalar_bit(scalar, i) == scalar_bit(scalar, i-int32(1)) {
			...
			w = v1
			v = -(scalar_bit(scalar, i) << (w - int32(1)))
			j = 0
			for {
				if !(j < w-int32(1)) {
					break
				}
				v = v + scalar_bit(scalar, i-(w-int32(1))+j)<<j
				goto _2
			_2:
				;
				j = j + 1
			}
			v = v + scalar_bit(scalar, i-w)
			...
			(*slide_ctx)(unsafe.Pointer(ctx)).Fnext_index = int16(i - (w - int32(1)) + s)
...
func crypto_eddsa_check_equation(tls *libc.TLS, signature uintptr, public_key uintptr, h uintptr) (r int32) {
	...
	if ge_frombytes_neg_vartime(tls, bp, public_key) != 0 || ge_frombytes_neg_vartime(tls, bp+160, signature) != 0 || is_above_l(bp+320) != 0 {
		return -int32(1)
	}
	...
	i = uint64(libc.Int32FromInt32(1))
	for {
		if !(i < uint64(int32(1)<<(int32(P_W_WIDTH)-int32(2)))) {
			break
		}
...
func lookup_add(tls *libc.TLS, p uintptr, tmp_c uintptr, tmp_a uintptr, tmp_b uintptr, comb uintptr, scalar uintptr, i int32) {
	...
	teeth = libc.Uint8FromInt32(scalar_bit(scalar, i) + scalar_bit(scalar, i+int32(32))<<int32(1) + scalar_bit(scalar, i+int32(64))<<int32(2) + scalar_bit(scalar, i+int32(96))<<int32(3))
	...
	for {
		...
		fe_ccopy(tmp_c, comb+uintptr(j)*120, select1)
		fe_ccopy(tmp_c+40, comb+uintptr(j)*120+40, select1)
		fe_ccopy(tmp_c+80, comb+uintptr(j)*120+80, select1)
		goto _1
	_1:
		;
		j = j + 1
	}
	fe_neg(tmp_a, tmp_c+80)
	fe_cswap(tmp_c+80, tmp_a, libc.Int32FromUint8(high)^int32(1))
	fe_cswap(tmp_c, tmp_c+40, libc.Int32FromUint8(high)^int32(1))
...
func ge_scalarmult_base(tls *libc.TLS, p uintptr, scalar uintptr) {
	...
	lookup_add(tls, p, bp+112, bp+32, bp+72, uintptr(unsafe.Pointer(&b_comb_high)), bp, int32(31)+int32(128))
	...
	crypto_wipe(bp+32, uint64(40))
	crypto_wipe(bp+232, uint64(160))
	crypto_wipe(bp+72, uint64(40))
	crypto_wipe(bp+112, uint64(120))
	crypto_wipe(bp, uint64(32))
}
...
func crypto_eddsa_key_pair(tls *libc.TLS, secret_key uintptr, public_key uintptr, seed uintptr) {
	...
	_i_1 = uint64(libc.Int32FromInt32(0))
	for {
		if !(_i_1 < uint64(libc.Int32FromInt32(32))) {
			break
		}
	...
	crypto_eddsa_trim_scalar(bp, bp)
	crypto_eddsa_scalarbase(tls, secret_key+uintptr(32), bp)
	_i_2 = uint64(libc.Int32FromInt32(0))
	for {
		if !(_i_2 < uint64(libc.Int32FromInt32(32))) {
			break
		}
...
func crypto_eddsa_to_x25519(tls *libc.TLS, x25519 uintptr, eddsa uintptr) {
	...
	fe_add(bp, uintptr(unsafe.Pointer(&fe_one)), bp+40)
	fe_sub(bp+40, uintptr(unsafe.Pointer(&fe_one)), bp+40)
...
func crypto_x25519_to_eddsa(tls *libc.TLS, eddsa uintptr, x25519 uintptr) {
	...
	fe_sub(bp, bp+40, uintptr(unsafe.Pointer(&fe_one)))
	fe_add(bp+40, bp+40, uintptr(unsafe.Pointer(&fe_one)))
	fe_invert(tls, bp+40, bp+40)
	fe_mul(bp, bp, bp+40)
...
func add_xl(tls *libc.TLS, s uintptr, x u8) {
	...
	var i size_t
	_, _, _ = carry, i, mod8
	mod8 = uint64(libc.Int32FromUint8(x) & int32(7))
	carry = uint64(0)
	i = uint64(libc.Int32FromInt32(0))
	for {
		if !(i < uint64(libc.Int32FromInt32(8))) {
		...
		carry = carry + uint64(load32_le(s+uintptr(uint64(4)*i))) + uint64(L[i])*mod8
		store32_le(s+uintptr(uint64(4)*i), uint32(carry))
		carry = carry >> uint64(32)
		goto _1
	_1:
		;
...
func crypto_x25519_dirty_small(tls *libc.TLS, public_key uintptr, secret_key uintptr) {
	...
	crypto_eddsa_trim_scalar(bp, secret_key)
...
func select_lop(tls *libc.TLS, out uintptr, x uintptr, k uintptr, cofactor u8) {
	...
	var _ /* tmp at bp+0 */ fe
	fe_0(out)
	fe_ccopy(out, k, libc.Int32FromUint8(cofactor)>>int32(1)&int32(1)) // bit 1
	fe_ccopy(out, x, libc.Int32FromUint8(cofactor)>>0&int32(1))        // bit 0
	fe_neg(bp, out)
	fe_ccopy(out, bp, libc.Int32FromUint8(cofactor)>>int32(2)&int32(1)) // bit 2
	crypto_wipe(bp, uint64(40))
}
...
func crypto_x25519_dirty_fast(tls *libc.TLS, public_key uintptr, secret_key uintptr) {
	...
	fe_add(bp+272, bp+232, bp+192)
	fe_sub(bp+272+40, bp+232, bp+192)
	fe_mul(bp+272+80, bp+232, bp+192)
	fe_mul(bp+272+80, bp+272+80, uintptr(unsafe.Pointer(&D2)))
	...
	fe_add(bp+192, bp+32+80, bp+32+40)
	fe_sub(bp+232, bp+32+80, bp+32+40)
	fe_invert(tls, bp+232, bp+232)
	fe_mul(bp+192, bp+192, bp+232)
	fe_tobytes(tls, public_key, bp+192)
	crypto_wipe(bp+192, uint64(40))
	crypto_wipe(bp+32, uint64(160))
	crypto_wipe(bp+232, uint64(40))
	crypto_wipe(bp+272, uint64(120))
	crypto_wipe(bp, uint64(32))
}
...
func crypto_elligator_map(tls *libc.TLS, curve uintptr, hidden uintptr) {
	...
	fe_sq(bp, bp)
	fe_add(bp+80, bp, bp)
	fe_add(bp+40, bp+80, uintptr(unsafe.Pointer(&fe_one)))
	fe_sq(bp+120, bp+40)
	fe_mul(bp+160, uintptr(unsafe.Pointer(&A2)), bp+80)
	fe_sub(bp+160, bp+160, bp+120)
	fe_mul(bp+160, bp+160, uintptr(unsafe.Pointer(&A)))
	fe_mul(bp+80, bp+120, bp+40)
	fe_mul(bp+80, bp+160, bp+80)
	is_square = invsqrt(tls, bp+80, bp+80)
	fe_mul(bp+40, bp, uintptr(unsafe.Pointer(&ufactor)))
	fe_ccopy(bp+40, uintptr(unsafe.Pointer(&fe_one)), is_square)
	fe_sq(bp+80, bp+80)
	fe_mul(bp+40, bp+40, uintptr(unsafe.Pointer(&A)))
	fe_mul(bp+40, bp+40, bp+160)
	fe_mul(bp+40, bp+40, bp+120)
	fe_mul(bp+40, bp+40, bp+80)
	fe_neg(bp+40, bp+40)
...
func crypto_elligator_rev(tls *libc.TLS, hidden uintptr, public_key uintptr, tweak u8) (r int32) {
	...
	fe_add(bp+40, bp, uintptr(unsafe.Pointer(&A))) // t2 = u + A
	fe_mul(bp+80, bp, bp+40)
	fe_mul_small(bp+80, bp+80, -int32(2))
	...
	if is_square != 0 {
		...
		fe_ccopy(bp, bp+40, libc.Int32FromUint8(tweak)&int32(1)) // multiply by u if v is positive,
		fe_mul(bp+80, bp, bp+80)                                 // multiply by u+A otherwise
		fe_mul_small(bp, bp+80, int32(2))
		fe_neg(bp+40, bp+80)
		fe_ccopy(bp+80, bp+40, fe_isodd(tls, bp))
		fe_tobytes(tls, hidden, bp+80)
		// Pad with two random bits
		v1 = hidden + 31
		*(*u8)(unsafe.Pointer(v1)) = u8(int32(*(*u8)(unsafe.Pointer(v1))) | libc.Int32FromUint8(tweak)&int32(0xc0))
	}
	crypto_wipe(bp, uint64(40))
	crypto_wipe(bp+40, uint64(40))
	crypto_wipe(bp+80, uint64(40))
...
func redc(tls *libc.TLS, u uintptr, x uintptr) {
	...
	**(**[16]u32)(__ccgo_up(bp + 32)) = [16]u32{}
	multiply(bp+32, bp, uintptr(unsafe.Pointer(&L)))
	// t = t + x
	carry1 = uint64(0)
	i1 = uint64(libc.Int32FromInt32(0))
	for {
...
func crypto_x25519_inverse(tls *libc.TLS, blind_salt uintptr, private_key uintptr, curve_point uintptr) {
	...
	**(**[8]u32)(__ccgo_up(bp)) = [8]u32{
	...
	crypto_eddsa_trim_scalar(bp+32, private_key)
	_i_ = uint64(libc.Int32FromInt32(0))
	for {
		if !(_i_ < uint64(libc.Int32FromInt32(8))) {
			break
	...
	crypto_wipe(bp+96, uint64(64)) // Wipe ASAP to save stack space
	i = int32(252)
	for {
		if !(i >= 0) {
			break
		...
		multiply(bp+160, bp, bp)
		redc(tls, bp, bp+160)
		if scalar_bit(uintptr(unsafe.Pointer(&Lm2)), i) != 0 {
			_i_2 = uint64(libc.Int32FromInt32(0))
			for {
				if !(_i_2 < uint64(libc.Int32FromInt32(16))) {
					break
				}
	...
	_i_3 = uint64(libc.Int32FromInt32(0))
	for {
		if !(_i_3 < uint64(libc.Int32FromInt32(8))) {
			break
		}
	...
	_i_4 = uint64(libc.Int32FromInt32(0))
	for {
		if !(_i_4 < uint64(libc.Int32FromInt32(8))) {
			break
		}
...
func lock_auth(tls *libc.TLS, mac uintptr, auth_key uintptr, ad uintptr, ad_size size_t, cipher_text uintptr, text_size size_t) {
	...
	crypto_poly1305_update(tls, bp+16, uintptr(unsafe.Pointer(&zero)), gap(ad_size, uint64(16)))
	crypto_poly1305_update(tls, bp+16, cipher_text, text_size)
	crypto_poly1305_update(tls, bp+16, uintptr(unsafe.Pointer(&zero)), gap(text_size, uint64(16)))
...
func crypto_aead_init_djb(ctx uintptr, key uintptr, nonce uintptr) {
	var _i_, _i_1 size_t
	_, _ = _i_, _i_1
	_i_ = uint64(libc.Int32FromInt32(0))
	for {
	...
	_i_1 = uint64(libc.Int32FromInt32(0))
	for {
		if !(_i_1 < uint64(libc.Int32FromInt32(8))) {
			break
		}
...
func crypto_aead_init_ietf(tls *libc.TLS, ctx uintptr, key uintptr, nonce uintptr) {
	...
	(*crypto_aead_ctx)(unsafe.Pointer(ctx)).Fcounter = uint64(load32_le(nonce)) << int32(32)
}
