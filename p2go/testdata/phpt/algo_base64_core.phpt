--TEST--
Algorithme réel base64_core — EXPECT gravé depuis l'oracle CLI php 8.3.6 (TestAlgorithmsVsPhpOracle le re-vérifie en vif)
--FILE--
<?php
...
bGlnaHQgd29yay4=
light work.
cDJnbzogUEhQIC0+IEdvIDEuMjcsIGFyY2hzaW1kIGluc2lkZSE=
p2go: PHP -> Go 1.27, archsimd inside!
roundtrip ok
