...
func Md5_transform_block(tls *libc.TLS, state uintptr, block uintptr) {
	...
	a = bits.RotateLeft32(a, int(7))
	a = a + b
	d = d + (a&b | ^a&c + x[int32(1)] + uint32(0xe8c7b756))
	d = bits.RotateLeft32(d, int(12))
	d = d + a
	c = c + (d&a | ^d&b + x[int32(2)] + uint32(libc.Int32FromInt32(0x242070db)))
	c = bits.RotateLeft32(c, int(17))
	c = c + d
