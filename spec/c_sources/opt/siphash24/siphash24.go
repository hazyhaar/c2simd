...
func Siphash24(tls *libc.TLS, in uintptr, inlen size_t, k uintptr) (r uint64_t) {
	...
	end = in + uintptr(inlen) - uintptr(inlen%uint64(8))
	for {
		if !(in != end) {
			break
		}
		...
		v1 = v1 ^ v0
		v0 = bits.RotateLeft64(v0, int(32))
		v2 = v2 + v3
		v3 = bits.RotateLeft64(v3, int(16))
		v3 = v3 ^ v2
		v0 = v0 + v3
		v3 = bits.RotateLeft64(v3, int(21))
		v3 = v3 ^ v0
		v2 = v2 + v1
		v1 = bits.RotateLeft64(v1, int(17))
		v1 = v1 ^ v2
