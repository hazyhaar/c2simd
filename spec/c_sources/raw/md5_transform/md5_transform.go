...
func Md5_transform_block(tls *libc.TLS, state uintptr, block uintptr) {
	var a, b, c, d uint32_t
	var i int32
	var x [16]uint32_t
	...
	a = a + (b&c | ^b&d + x[0] + libc.Uint32FromUint32(0xd76aa478))
	a = a<<libc.Int32FromInt32(7) | a>>(libc.Int32FromInt32(32)-libc.Int32FromInt32(7))
	a = a + b
	d = d + (a&b | ^a&c + x[int32(1)] + libc.Uint32FromUint32(0xe8c7b756))
	d = d<<libc.Int32FromInt32(12) | d>>(libc.Int32FromInt32(32)-libc.Int32FromInt32(12))
	d = d + a
	c = c + (d&a | ^d&b + x[int32(2)] + libc.Uint32FromInt32(libc.Int32FromInt32(0x242070db)))
	c = c<<libc.Int32FromInt32(17) | c>>(libc.Int32FromInt32(32)-libc.Int32FromInt32(17))
	c = c + d
	b = b + (c&d | ^c&a + x[int32(3)] + libc.Uint32FromUint32(0xc1bdceee))
	b = b<<libc.Int32FromInt32(22) | b>>(libc.Int32FromInt32(32)-libc.Int32FromInt32(22))
	b = b + c
