...
func Siphash24(tls *libc.TLS, in uintptr, inlen size_t, k uintptr) (r uint64_t) {
	...
	end = in + uintptr(inlen) - uintptr(inlen%libc.Uint64FromInt32(8))
	for {
		if !(in != end) {
			break
		}
		...
		v3 = v3 ^ m
		v0 = v0 + v1
		v1 = v1<<libc.Int32FromInt32(13) | v1>>(libc.Int32FromInt32(64)-libc.Int32FromInt32(13))
		v1 = v1 ^ v0
		v0 = v0<<libc.Int32FromInt32(32) | v0>>(libc.Int32FromInt32(64)-libc.Int32FromInt32(32))
		v2 = v2 + v3
		v3 = v3<<libc.Int32FromInt32(16) | v3>>(libc.Int32FromInt32(64)-libc.Int32FromInt32(16))
		v3 = v3 ^ v2
		v0 = v0 + v3
		v3 = v3<<libc.Int32FromInt32(21) | v3>>(libc.Int32FromInt32(64)-libc.Int32FromInt32(21))
		v3 = v3 ^ v0
		v2 = v2 + v1
		v1 = v1<<libc.Int32FromInt32(17) | v1>>(libc.Int32FromInt32(64)-libc.Int32FromInt32(17))
		v1 = v1 ^ v2
		v2 = v2<<libc.Int32FromInt32(32) | v2>>(libc.Int32FromInt32(64)-libc.Int32FromInt32(32))
		v0 = v0 + v1
		v1 = v1<<libc.Int32FromInt32(13) | v1>>(libc.Int32FromInt32(64)-libc.Int32FromInt32(13))
		v1 = v1 ^ v0
		v0 = v0<<libc.Int32FromInt32(32) | v0>>(libc.Int32FromInt32(64)-libc.Int32FromInt32(32))
	...
	b = inlen << int32(56)
	switch inlen & libc.Uint64FromInt32(7) {
	case uint64(7):
